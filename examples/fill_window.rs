...
impl FullWindowView {
    fn new() -> View {
        VStack::new([
            ...
            HStack::new([
                VStack::new([
                    Text::new("Left").color(Color::new(1.0, 1.0, 1.0, 1.0)),
                    Text::new("Panel").color(Color::new(1.0, 1.0, 1.0, 1.0)),
                ])
                .padding(16.0)
                .background(Color::new(0.8, 0.3, 0.3, 1.0)),
                VStack::new([
                    Text::new("Center").color(Color::new(1.0, 1.0, 1.0, 1.0)),
                    Text::new("Panel").color(Color::new(1.0, 1.0, 1.0, 1.0)),
                ])
                .padding(16.0)
                .background(Color::new(0.3, 0.8, 0.3, 1.0)),
                VStack::new([
                    Text::new("Right").color(Color::new(1.0, 1.0, 1.0, 1.0)),
                    Text::new("Panel").color(Color::new(1.0, 1.0, 1.0, 1.0)),
                ])
                .padding(16.0)
